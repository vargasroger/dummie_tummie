...
return [
    ...
    */
    'pages' => [
        'welcome' => [
            'subtitle' => 'Este é um App incrível',
        ],
    ],
    'users' => [
    ...
    'emails' => [
        'auth' => [
            ...
            'verify_your_email' => 'Verifique sua caixa de e-mail',
            'verification_link' => 'Um novo link de verificação foi enviado para o seu e-mail.',
            'check_your_email' => 'Para proseguir, acesse o link de verificação no seu e-mail ',
            'if_did_not_receive' => 'Caso não tenha recebido o e-mail',
            'request_another' => 'clique aqui para solicitar outro e-mail',
        ],
